  ...
  <div class="lg:flex md:w-full">
    <div class="float-left w-full">
      <div class="h-auto m-3 bg-white shadow-md rounded-lg transition duration-300 hover:shadow-xl p-3 ">
        ...
        <div class="animate__animated animate__fadeIn" v-if="list.length > 0">
          <div class="w-full  lg:w-full mx-auto relative 2xl:p-20 xl:p-20 lg:p-20 md:p-20 sm:p-10">
            <h1 class="text-3xl text-center font-bold text-black">{{title}}</h1>
            <div class="border-l-2 mt-10">
              ...
              >
                ...
                <div class="flex-auto">
                  <h1 class="text-xl font-bold">{{ listItem.title }}</h1>
                  <h3>{{ listItem.text }}</h3>
                </div>
              </div>
            </div>
